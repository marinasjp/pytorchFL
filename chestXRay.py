...
#
# [0.50740504 0.50740504 0.50740504]
# [0.24995194 0.24995194 0.24995194]
# print(mean)
# print(std)
# #
...
for dirpath, dirnames, filenames in os.walk(DATA_DIR):
    for filename in filenames:
        ...
        if label not in labels:
            labels.append(label)
        data["path"].append(os.path.join(dirpath, filename))
        data["Finding Labels"].append(label)
...
mean, std = [0.8738966, 0.7487087, 0.7215933], [0.15496783, 0.18204536, 0.07819032] #2
print(mean)
print(std)
composed_train = v2.Compose([v2.ToImage(),
                             v2.ToDtype(torch.float32, scale=True),
